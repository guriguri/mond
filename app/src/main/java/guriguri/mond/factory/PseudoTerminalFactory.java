...
/**
 * reference: https://github.com/stepinto/android-sshd
 */
public class PseudoTerminalFactory implements Factory<Command> {
    private static final Logger log = LoggerFactory.getLogger(PseudoTerminalFactory.class);
